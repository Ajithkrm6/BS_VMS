    ...
    <Card className="w-full max-w-sm border-none shadow-none ring-0">
      ...
      <CardContent>
        <form onSubmit={handleSubmit}>
          <div className="flex flex-col gap-6">
            ...
            <div className="grid gap-2">
              <div className="flex items-center">
                <Label htmlFor="password" className='text-[#3A3541]'>Password</Label>
              </div>
              <Input
                id="password"
                type="password"
          ...
          <CardFooter className="flex flex-col md:flex-row gap-2 px-0 mt-6 flex border-none w-full">
            <Button type="button" variant="outline" className="flex-1 px-2 py-3 md:px-3 md:py-5 rounded-[17px] border border-[#DBDCDE] w-full" >
              <FcGoogle/>
              Signin with Google
            </Button>
            <Button type="button" variant="outline" className="flex-1 px-2 py-3 md:px-3 md:py-5 rounded-[17px] border border-[#DBDCDE] w-full">
